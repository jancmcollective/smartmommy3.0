...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 center articletitle text-center"><h1>NIJNTJE DANSENDE BLOKJES</h1></div>
                <div class="col-xs-10 col-xs-offset-1 col-md-6 col-md-offset-3">
                    <img  class="responsive-img" src="img/2017/05/Nijntje-dansende-blokjes-1.jpg" alt="...">
                </div>
            </div>
        </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-5 col-xs-offset-1 col-md-2 col-md-offset-2"><img src="img/2017/05/Nijntje-dansende-blokjes--150x150.jpg" alt=""/></div>
                    <div class="col-xs-5 col-md-2"><img src="img/2017/05/cijfer-rondje.JPG" alt=""/></div>
                    <div class="col-xs-10 col-xs-offset-1 col-md-4">
                        <dl>
                ...
                <div class="row">
                    <div class="col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2">
                        ...
                        <img  class="responsive-img center-block" src="img/2017/05/Nijntje-dansende-blokjes-4.jpg" alt="...">
                        <strong class="text-sm">De eerste die de meeste blokken bij elkaar heeft verzameld is de winnaar…</strong>
